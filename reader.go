...
func (r *Reader) Read() (*Frame, error) {
	...
	case CommandAbort, CommandACK, CommandBegin, CommandCommit,
		CommandConnect, CommandDisconnect, CommandNack, CommandSend,
		CommandStomp, CommandSubscribe, CommandUnsubscribe, CommandConnected,
		CommandError, CommandMessage, CommandHeartbeat:
		// valid command
	default:
